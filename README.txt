...
Los grupos facilitan la actualización y dibujo eficiente de los sprites en pantalla.
...
Se implementa una probabilidad de crear nuevas plantas en cada iteración del bucle.
Eventos del Teclado:
